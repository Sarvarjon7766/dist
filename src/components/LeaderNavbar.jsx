...
const LeaderNavbar = ({ onMenuToggle }) => {
				...
				<div className="w-full max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
					...
					<div className="flex items-center space-x-6">
						...
						<div className="relative">
							...
							>
								<div className="h-12 w-12 rounded-full bg-blue-600 flex items-center justify-center border-2 border-blue-400 group-hover:border-blue-300 transition-all overflow-hidden">
									{user?.photo ? (
										<img
